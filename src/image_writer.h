...
template <class ImageType> class ImageWriter {
public:
  static bool WritePNG(ImageType &image, const char *filename) {
     ...
     */
    png_set_IHDR(png_ptr, info_ptr, (png_uint_32)image.width(),
                 (png_uint_32)image.height(), 8, PNG_COLOR_TYPE_RGB,
     ...
     */
    if (image.height() > PNG_UINT_32_MAX)
