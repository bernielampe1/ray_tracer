...
public:
  ...
  static XVec3f _compute_normal(const XVec3f &pt0, const XVec3f &pt1,
                                const XVec3f &pt2) {
  ...
  /// that pt0 corresponds to (u=0,v=0), pt1 is at (u=1,v=0), pt2 is at
  /// (u=0,v=1)
  ///
  static bool _intersect(const XVec3f &pt0, const XVec3f &pt1,
                         const XVec3f &pt2, const ray_t &ray, float &t,
                         float &u, float &v) {
    XVec3f d = ray.m_dir;
    d.normalize();
